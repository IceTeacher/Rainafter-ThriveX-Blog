...
export default async ({ params, searchParams }: Props) => {
    ...
    return (
        <>
            ...
            <div className='flex flex-col flex-grow justify-between pt-16 pb-[119px] border-b dark:border-[#4e5969] bg-[linear-gradient(to_right,#fff1eb_0%,#d0edfb_100%)] dark:bg-[linear-gradient(to_right,#232931_0%,#232931_100%)] transition-colors'>
                <div>
